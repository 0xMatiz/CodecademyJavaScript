...
let paladin = 'Fight';
const light = 'faith';
console.log(`${paladin} with ${light}!.`);

//console.log(rogue); //reference error: rogue is not defined
let rogue;
console.log(rogue);
console.log(`rogues could be described as ${rogue}`);

//console.log(mage); //reference error: mage is not defined
const mage = 'learning spells.';
console.log(mage);

//console.log(shaman); //returns undefined
var shaman = 'thinking of the elements.'
console.log(shaman);

let numberOfClasses = 11;
console.log(typeof numberOfClasses);

let paladinIsOp = true;

console.log(typeof shaman);
console.log(typeof rogue);
console.log(typeof paladin);
console.log(typeof paladinIsOp);
