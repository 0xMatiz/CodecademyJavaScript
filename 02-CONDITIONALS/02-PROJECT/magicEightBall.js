...
//Define the user name or leave empty.
let userName = 'Matias'; 
//Welcoming message 🙌
userName ? console.log(`Hello,${userName}!`) : console.log('Hello!');
//User question to the magic ball 🐳.
const userQuestion = 'Will i get to have luck this year?';
//The user question 👾
console.log(`${userName} your question was, ${userQuestion}`);
//Random number between 0 and 7 (rounded down).
let randomNumber = Math.floor(Math.random() * 8);
//Magic Eight Ball.
let eightBall = ''
//These results equal the random numbers.
eightBall = randomNumber;
//A list of answers to that random numbers results.
switch (eightBall) {
  case 0:
